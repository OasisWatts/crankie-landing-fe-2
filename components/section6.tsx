...
//     setCurrentBox((prevBox) => (prevBox % totalBoxes) + 1);
//     console.log(`Video ended. Switching to Box ${(currentBox % totalBoxes) + 1}`);
//   };
...
//     if (currentBox === 1) {
//       videoSrc = '/video/6page_location-mp4.mp4'; // 첫 번째 동영상 경로
//     } else if (currentBox === 2) {
//       videoSrc = '/video/6page_location.mp4'; // 두 번째 동영상 경로
//     } else if (currentBox === 3) {
//       videoSrc = '/video/6page_casting.mp4'; // 세 번째 동영상 경로
//     }
...
//         controls
//         autoPlay
//         loop={false} // 자동 재생 후 반복하지 않도록 설정
//         muted
